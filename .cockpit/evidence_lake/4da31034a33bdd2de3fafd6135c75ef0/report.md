...
| :--- | :--- | :--- |
| **Overall Health Score** | 66.7% | ➡️ +0.0% |
| **Governance Gates** | 6 / 9 | - |
...
> The current audit health score (66.7%) is below your configured threshold (80%).
...
1. **Missing 5th Golden Signal**
   - 📍 Location: `/home/sad9605/cathedral-core/tsf_forecast.py:1`
   - ✨ Strategy: Structural Enhancement.
1. **Credential Risk: Shadow**
   - 📍 Location: `/home/sad9605/cathedral-core/cascade_engine.py:1`
   - ✨ Strategy: Structural Enhancement.
1. **ASI-04: Tool**
   - 📍 Location: `/home/sad9605/cathedral-core/cascade_engine.py:1`
...
1. **🏛️ Structural Monolith**
   - 📍 Location: `Core Enhancements`
   - ✨ Strategy: Generic best practice upgrade recommended for 3 files (/home/sad9605/cathedral-core/cascade_engine.py, /home/sad9605/cathedral-core/daily-sweep.py...)
1. **Policy Blindness: Implicit**
   - 📍 Location: `/home/sad9605/cathedral-core/monte_carlo.py:1`
   - ✨ Strategy: Structural Enhancement.
1. **Missing 5th Golden Signal**
   - 📍 Location: `Core Enhancements`
   - ✨ Strategy: Generic best practice upgrade recommended for 6 files (/home/sad9605/cathedral-core/monte_carlo.py, /home/sad9605/cathedral-core/daily_sweep.py...)
1. **Credential Risk: Shadow**
   - 📍 Location: `/home/sad9605/cathedral-core/daily-sweep.py:1`
   - ✨ Strategy: Structural Enhancement.
...
1. **Missing 5th**
   ...
   - ✨ Strategy: Structural Enhancement.
1. **Missing 5th**
   - 📍 Location: `/home/sad9605/cathedral-core/agentic/policy_engine.py:1`
   - ✨ Strategy: Structural Enhancement.
1. **ASI-01: Untrusted**
...
| :--- | :--- | :--- |
| Declarative Guardrails | [Doc](https://cloud.google.com/architecture/framework/security) | Google Cloud Governance Best Practices: Input Sanitization & Tool HITL |
...
### Red Team (Fast) Artifacts
```text
╭───────────────────────────────────────────────╮
│ 🚩 RED TEAM EVALUATION: SELF-HACK INITIALIZED │
╰───────────────────────────────────────────────╯
Targeting: /home/sad9605/cathedral-core/tsf_forecast.py
📝 Generated Promptfoo Config: 
/home/sad9605/cathedral-core/.cockpit/promptfooconfig.json
🚀 Running Promptfoo Evaluation...
❌ Error running Promptfoo: Traceback (most recent call last):
  File 
"/home/sad9605/.cache/uv/archive-v0/ce19eYkRFBRYRdP2/lib/python3.13/site-packages/
agent_ops_cockpit/eval/red_team.py", line 148, in audit
...
venv/lib/python3.13/site-packages/aeon/datasets/data/ArrowHead/ArrowHead_TRAIN.ts:
1 | Missing Branding (Logo) or SEO Metadata (OG/Description) | Add: `<meta 
property='og:image' content='/logo.png' />`


                            🔍 GENUI DETAILED FINDINGS                            
┏━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ File:Line                ┃ Issue                    ┃ Recommended Fix          ┃
┡━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ venv/lib/python3.13/sit… │ Missing Branding (Logo)  │ Add: `<meta              │
│                          │ or SEO Metadata          │ property='og:image'      │
│                          │ (OG/Description)         │ content='/logo.png' />`  │
└──────────────────────────┴──────────────────────────┴──────────────────────────┘
...
│ Contract Compliance (GenUI) │ GAP DETECTED │ Missing AGUI/CopilotKit Renderer  │
│                             │              │ registration                      │
